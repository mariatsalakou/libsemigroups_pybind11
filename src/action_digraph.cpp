...
// Copyright (C) 2021 Maria Tsalakou
//
...
namespace libsemigroups {
  void init_action_digraph(py::module &m) {
   ...
   /* .def("random",
    ...
    .def("random",
             py::overload_cast<T const,T const,T
    const,std::mt19937>(&libsemigroups::ActionDigraph::random),
             py::arg("nr_nodes"), py::arg("out_degree"), py::arg("nr_edges"),
    py::arg("mt"), R"pbdoc( Constructs a random ActionDigraph from mt with the
    specified number of nodes and edges, and out-degree.

                   :Parameters: - **nr_nodes** (??) - the number of nodes
                                - **out_degree** (??) - the out-degree of every
    node
                                - **nr_edges** (??) - the out-degree of every
    node
                                - **mt** (??) - a std::mt19937 used as a random
    source (defaults to: std::mt19937(std::random_device()()))
    ...
    .def("add_nodes",
             &libsemigroups::ActionDigraph::add_nodes,
             py::arg("nr"),
             R"pbdoc(
    ...
    .def("add_to_out_degree",
             &libsemigroups::ActionDigraph::add_to_out_degree,
             py::arg("nr"),
             R"pbdoc(
    ...
    .def("add_edge",
             &libsemigroups::ActionDigraph::add_edge,
    ...
    .def("reserve",
             &libsemigroups::ActionDigraph::reserve,
             py::arg("m"), py::arg("n"),
             R"pbdoc(
    ...
    .def("neighbor",
             &libsemigroups::ActionDigraph::neighbor,
             py::arg("v"), py::arg("lbl"),
             R"pbdoc(
    ...
    ActionDigraph::node_type. )pbdoc") .def("unsafe_neighbor",
             &libsemigroups::ActionDigraph::unsafe_neighbor,
             py::arg("v"), py::arg("lbl"),
             R"pbdoc(
                   Get the range of the edge with source node v and edge-label
    lbl.
                   ...
                   :return: Returns the node adjacent to v via the edge labelled
    lbl, or libsemigroups::UNDEFINED; both are values of type
    ActionDigraph::node_type. )pbdoc") .def("next_neighbor",
             &libsemigroups::ActionDigraph::next_neighbor,
             py::arg("v"), py::arg("i"),
             R"pbdoc(
    ...
    .def("unsafe_next_neighbor",
             &libsemigroups::ActionDigraph::unsafe_next_neighbor,
             py::arg("v"), py::arg("i"),
             R"pbdoc(
                   Get the next neighbor of a node that doesn't equal
    libsemigroups::UNDEFINED.
    ...
    .def("nr_nodes",
             &libsemigroups::ActionDigraph::nr_nodes,
             R"pbdoc(
    ...
    .def("nr_edges",
             py::overload_cast<>(&libsemigroups::ActionDigraph::nr_edges,
    ...
    const>(&libsemigroups::ActionDigraph::nr_edges, py::const_), py::arg("n"),
             R"pbdoc(
    ...
    .def("out_degree",
             &libsemigroups::ActionDigraph::out_degree,
             R"pbdoc(
                   Returns the out-degree of this.

                   :return: The number of out-edges of every node, a value of
    type T. )pbdoc") .def("validate", &libsemigroups::ActionDigraph::validate,
             R"pbdoc(
    ...
    .def("scc_id",
             &libsemigroups::ActionDigraph::scc_id,
             py::arg("nd"),
             R"pbdoc(
                   Returns the id-number of the strongly connected component of
    a node.
    ...
    scc_index_type. )pbdoc") .def("nr_scc",
             &libsemigroups::ActionDigraph::nr_scc,
             R"pbdoc(
    ...
    .def("root_of_scc",
             &libsemigroups::ActionDigraph::root_of_scc,
             py::arg("nd"),
             R"pbdoc(
    ...
    of ActionDigraph::node_type. )pbdoc") .def("cbegin_sccs",
    ...
    .def("cend_sccs",
             ...
             R"pbdoc(
                   Returns an iterator pointing one past the last vector of
    nodes in the final scc.
    ...
    .def("spanning_forest",
             &libsemigroups::ActionDigraph::spanning_forest,
             R"pbdoc(
    ...
    .def("reverse_spanning_forest",
             &libsemigroups::ActionDigraph::reverse_spanning_forest,
             R"pbdoc(
                   Returns a libsemigroups::Forest comprised of spanning trees
    for each scc of this, rooted on the minimum node of that component, with
    ...
    .def("number_of_paths_algorithm",
             py::overload_cast<node_type
    const>(&libsemigroups::ActionDigraph::number_of_paths_algorithm,
    ...
    .def("number_of_paths",
             py::overload_cast<node_type
    const>(&libsemigroups::ActionDigraph::number_of_paths, py::const_),
             py::arg("source"),
             R"pbdoc(
                   Returns the number of paths originating at the given source
    node.
    ...
    const>(&libsemigroups::ActionDigraph::number_of_paths_algorithm,
    py::const_), py::arg("source"), py::arg("min"), py::arg("max"), R"pbdoc(
    ...
    .def("number_of_paths",
             py::overload_cast<node_type const,size_t const,size_t
    const,algorithm const>(&libsemigroups::ActionDigraph::number_of_paths,
